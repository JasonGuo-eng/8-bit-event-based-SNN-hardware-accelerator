...
module weight_bram #(
    ...
    reg signed [DATA_WIDTH-1:0] mem [0:ROWS*COLS-1]; //Create an array called mem containing ROWS × COLS elements, where each element is a signed DATA_WIDTH-bit number.
