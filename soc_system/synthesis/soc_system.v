...
module soc_system (
		...
		input  wire        mpu_events_eventi,                // mpu_events.eventi
		output wire        mpu_events_evento,                //           .evento
		output wire [1:0]  mpu_events_standbywfe,            //           .standbywfe
		output wire [1:0]  mpu_events_standbywfi,            //           .standbywfi
	...
	soc_system_hps_0 #(
		...
		.h2f_mpu_eventi            (mpu_events_eventi),                //    h2f_mpu_events.eventi
		.h2f_mpu_evento            (mpu_events_evento),                //                  .evento
		.h2f_mpu_standbywfe        (mpu_events_standbywfe),            //                  .standbywfe
		.h2f_mpu_standbywfi        (mpu_events_standbywfi),            //                  .standbywfi
