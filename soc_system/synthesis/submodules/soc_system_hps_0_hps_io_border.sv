...
assign hps_io_gpio_inst_LOANIO49 = intermediate[3] ? intermediate[2] : 'z;
assign hps_io_gpio_inst_LOANIO50 = intermediate[5] ? intermediate[4] : 'z;
...
,.GPIO1_PORTA_OE({
    intermediate[5:5] // 21:21
   ,intermediate[3:3] // 20:20
   ,floating[39:20] // 19:0
  })
,.LOANIO2_O({
...
,.GPIO1_PORTA_O({
    intermediate[4:4] // 21:21
   ,intermediate[2:2] // 20:20
   ,floating[86:67] // 19:0
  })
,.LOANIO1_OE({
